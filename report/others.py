...
def related_testmethod(id): 
    ...
    yx_method_list1 = []  # 液相方法表格1
    yx_method_list2=[] # 液相方法表格2
    ...
    try:
        ...
        yx_method1 = YX_Method.objects.filter(testmethod=Testmethod_endreport)
        yx_method2 = YX_Method2.objects.filter(testmethod=Testmethod_endreport)
        ...
        for i in yx_method2:
            ...
            group.append(i.Mobile_phaseB)
            group.append(i.Mobile_phaseA)
            yx_method_list2.append(group)
   
        for i in yx_method_texts:
            yx_method_texts_list.append(i.text)

        print(yx_method_list1)
        print(yx_method_list2)

    except:
        pass

    return{"zp_method_list":zp_method_list,"zp_method_texts_list":zp_method_texts_list,"yx_method_list1":yx_method_list1,"yx_method_list2":yx_method_list2,"yx_method_texts_list":yx_method_texts_list}
...
def related_Reagents_Consumables(id):
    ...
    try:
        ...
        reagentsTable = ReagentsTable.objects.filter(reagents_Consumables=Reagents_Consumables_endreport)
        ...
        for i in reagentsTable:
            ...
            if i.Col8!="":
                group.append(i.Col8)
            reagentsTable_list.append(group)
    ...
    return{"reagentsTable_list":reagentsTable_list,"reagents_texts_list":reagents_texts_list,"consumables_texts_list":consumables_texts_list}
